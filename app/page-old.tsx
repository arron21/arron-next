...
export default function Home() {
  return (
    <main className="">
      <div className="mb-4">
        <h1 className="text-5xl font-serif inline">Arron McCrory</h1>
        <span className="ml-3 text-3xl text-zinc-600">noun</span>
      </div>
      ...
      <div className="text-2xl mt-2">
        <em>
          ...
          <a
            className="no-underline text-cyan-700"
            href="https://www.merriam-webster.com/dictionary/Aaron"
            target="_blank"
          >
            aaron
          </a>
