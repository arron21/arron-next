...
export default function Page() {
  return (
    <TextPage
      title="Backend"
      paragraphs={[
        "As a fullstack developer, I enjoy the best of both worlds—crafting engaging user experiences on the frontend while also solving complex challenges on the backend.",
